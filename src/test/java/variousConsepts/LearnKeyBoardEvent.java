...
public class LearnKeyBoardEvent {
	...
	public void loginTest() {
		...
		action.sendKeys(Keys.ENTER).build().perform(); // build perform helps the action class to build during the run
														// time
		// action.sendKeys(Keys.RETURN).build().perform(); //also can be used same as
		// ENTER
